...
const FilePreview = ({ params }) => {
  ...
  const trucateFileName = (string = "", maxLength = 15) => {
  ...
  return (
    <div className="flex text-center justify-center items-center flex-col">
      ...
      <div className="text-2xl font-bold text-center p-4">
        <span className="text-primary">Filesharing</span> App shared a file with
      ...
      >
        ...
        >
          ...
          <div className="h-auto rounded-lg bg-gray-200 mb-5">
            <article
              className={`${
                !changeDesign
                  ? ""
            ...
            >
              <div
                className={`${
                  !changeDesign ? "m-4" : "m-10"
                } rounded-[10px] bg-white sm:p-6`}
              >
                <time
                  datetime="2022-10-10"
                ...
                >
                  ...
                  {file?.type && file?.size
                    ? file?.type + " | " + (file?.size / 1080).toFixed(2) + "KB"
                    : ""}
                </time>
